...
class Board2 extends JPanel implements MouseListener {
    ...
    public Board2(){
    JFrame frame2= new JFrame("ORTA MAYIN TARLASI");
    frame2.setSize(800, 800);
    frame2.setLocation(600, 150);
    frame2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    //layout
    frame2.setLayout(new GridLayout(16,16));
